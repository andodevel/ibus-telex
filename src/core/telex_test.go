...
func Testandodevel_RemoveLastChar(t *testing.T) {
	ng := newStdEngine()
	ng.RemoveLastChar(true)
...
func Testandodevel_RestoreLastWord(t *testing.T) {
	ng := newStdEngine()
...
func Testandodevel_RestoreLastWord_TCVN(t *testing.T) {
...
func Testandodevel_Zprocessing(t *testing.T) {
	ng := newStdEngine()
